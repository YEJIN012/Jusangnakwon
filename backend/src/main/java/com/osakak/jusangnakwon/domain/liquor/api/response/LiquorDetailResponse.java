...
public class LiquorDetailResponse {
    ...
    @Builder
    public LiquorDetailResponse(Long id, String name, WriterDto writer, String image, Double ratingAvg, Long scrapCnt, Boolean scrapped, List<String> ingredients, List<String> tastes, String description, List<ReviewListDto> reviews, List<LiquorListItemDto> similarItems) {
        this.id = id;
        this.name = name;
        this.writer = writer;
        this.image = image;
